...
- (id)initWithSize:(CGSize)size {
    if ((self = [super initWithSize:size])) {
        ...
        SKSpriteNode *background = [SKSpriteNode spriteNodeWithImageNamed:@"Land"];
